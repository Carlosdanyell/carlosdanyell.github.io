  ...
  projects: {
    ...
    items: {
      ...
      devcount: {
        ...
        shots: {
          '01-inicio': 'Topo da landing page com chamada principal, destaques do serviço e ilustração',
          '02-servicos': 'Seção de serviços em cards, com o que cada um inclui',
          '03-como-funciona': 'Seção que explica como o trabalho funciona, em três etapas',
          '04-contato': 'Formulário de contato e canais de atendimento',
